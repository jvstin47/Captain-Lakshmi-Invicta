...
export const ARCHIVAL_EXHIBITS = [
  {
    ...
    caption: "Captain Lakshmi Swaminathan in the olive-drab uniform of the Rani of Jhansi Regiment, Azad Hind Fauj.",
    source: "National Archives of India & Netaji Research Bureau, Kolkata",
    significance: "One of the most defining images of 20th-century anti-colonial resistance, capturing the intersection of female leadership and military mobilization."
  },
  {
    id: "arch-02",
    ...
    caption: "Official proclamation document founding the Provisional Government of Free India with Captain Lakshmi listed as Minister for Women\'s Affairs.",
    source: "Azad Hind Archival Collection, Ministry of External Affairs",
    significance: "Recognized by 9 sovereign states during World War II, establishing an independent Indian administrative and military authority."
  },
  {
    id: "arch-03",
